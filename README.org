...
- [-] support org export
  ...
  - [-] export code results
    ...
    - [ ] export output streams / verbatim results
    - [ ] export dataframes
  - [-] export top-level structre
    - [X] list-of-cells
    - [X] version info
    - [-] metadata
  ...
  - what to do about running multiple non-code blocks together?
    ...
    - but markdown already supports horizontal rule …
